...
exports.PostgresSchemaProvider = void 0;
const pg_1 = require("pg");
class PostgresSchemaProvider {
    async getSchema(connectionString) {
        const pool = new pg_1.Pool({ connectionString, options: "-c default_transaction_read_only=on" });
        try {
      ...
      `);
            ...
            const relationships = fkResult.rows.map(r => ({
...
exports.PostgresSchemaProvider = PostgresSchemaProvider;
//# sourceMappingURL=PostgresSchemaProvider.js.map